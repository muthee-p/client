...
function Public() {
  ...
  return (
    <div>
      ...
      <div className= 'mt-8 text-sm ml-[10%] bg-zinc-600 border rounded-xl border-zinc-500 p-4 w-[70%] mb-16'>
      <p><span className='text-amber-500 font-mono'>Safety: </span>{selectedTopic.paragraph_five}</p>
